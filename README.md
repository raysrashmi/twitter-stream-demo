...
This is a sample template for parse-tweets - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name parse-tweets --tail
```
...
```bash
aws cloudformation delete-stack --stack-name parse-tweets
```
